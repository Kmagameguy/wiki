...
2. Check the subtitles type used in the MKV: `ffmpeg -i movie.mkv` (look for something like "Stream #0:0(eng): Subtitle: hdmvpgssubtitle
3. Extract the subtitles with something like: `ffmpeg -i movie.mkv -c copy -map 0:2 sub.sup`
4. Convert the .sup to .srt online: https://subtitletools.com/convert-to-srt-online